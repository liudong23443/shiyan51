...
if system == 'Windows':
    ...
    font_list = ['WenQuanYi Micro Hei', 'Noto Sans CJK JP', 'Noto Sans CJK SC', 'Noto Sans CJK TC', 
            ...
            try:
                ...
                try:
                    with st.spinner("正在生成SHAP解释图..."):
                        ...
                        # 获取当前系统适合的字体
                        font_name = font_list[0] if font_list else 'sans-serif'
                        
                        # 手动修改标题 - 使用系统适配的字体
                        plt.title("特征对预测的影响", fontsize=12, fontname=font_name, fontweight='bold', color='black')
